...
# goldenphonetic has publish-goldenphonetic.yml but has not cut its first PyPI
# release yet (pypistats 404s until then); move it into PYPI_PACKAGES + the
# README pepy.tech ?q= list once published, same as the goldenmatch-hnsw note.
_PYPI_PUBLISH_BADGE_EXCEPTIONS = {"goldenmatch-pg", "goldenmatch-hnsw", "infermap-native", "er-matcher", "goldenphonetic"}

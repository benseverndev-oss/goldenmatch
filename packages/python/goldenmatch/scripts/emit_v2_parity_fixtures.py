...
def _run_probabilistic() -> dict[str, Any]:
    ...
    # The link-cut router (GOLDENMATCH_FS_CUT_ROUTER, on by default since P5) moves the same
    # cutoff per matchkey; pin it off so the fixture stays the math both surfaces share.

...
- **Postgres (pgrx)** — see the `postgres/` note (native-direct `goldenmatch_hnsw_pairs` (0.10.0) + `goldenmatch_lsh_pairs` (0.11.0) set-functions, CI-only build).

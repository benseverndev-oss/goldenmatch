...
- **Postgres (pgrx)** — see the `postgres/` note (native-direct `goldenmatch_hnsw_pairs` (0.10.0) + `goldenmatch_lsh_pairs` (0.11.0) + `goldenmatch_perceptual_phash`/`_hamming` (0.12.0) set/scalar-functions, CI-only build).

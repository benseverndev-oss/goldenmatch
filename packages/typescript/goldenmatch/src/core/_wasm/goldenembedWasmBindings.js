...
/* @ts-self-types="./goldenembed_wasm.d.ts" */
...
export class Embedder {
     ...
     */
    get dim() {
        const ret = wasm.embedder_dim(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     * @param {number} dim
     * @param {Float32Array | null | undefined} bias
     * @param {number} n_features
     * @param {number} ngram_min
     * @param {number} ngram_max
     * @param {boolean} lowercase
     * @param {string} boundary
     * @param {number} seed
     */
    constructor(weights, dim, bias, n_features, ngram_min, ngram_max, lowercase, boundary, seed) {
        ...
        const ptr2 = passStringToWasm0(boundary, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.embedder_new(ptr0, len0, dim, ptr1, len1, n_features, ngram_min, ngram_max, lowercase, ptr2, len2, seed);
        if (ret[2]) {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./goldenembed_wasm_bg.js": import0,
    };
}

const EmbedderFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_embedder_free(ptr, 1));

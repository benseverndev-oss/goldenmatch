...
/* @ts-self-types="./cluster_wasm.d.ts" */
 ...
 * @returns {string}
 */
export function cluster_confidence(edges_a, edges_b, edges_w, size) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        const ptr2 = passArrayF64ToWasm0(edges_w, wasm.__wbindgen_malloc);
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.cluster_confidence(ptr0, len0, ptr1, len1, ptr2, len2, size);
        deferred4_0 = ret[0];
        deferred4_1 = ret[1];
 ...
 * @returns {string}
 */
export function mst_split_components(members, edges_a, edges_b, edges_w) {
    let deferred5_0;
    let deferred5_1;
    try {
        ...
        const ret = wasm.mst_split_components(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
        deferred5_0 = ret[0];
        deferred5_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {

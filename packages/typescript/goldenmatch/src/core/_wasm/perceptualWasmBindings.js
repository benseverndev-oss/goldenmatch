...
/* @ts-self-types="./goldenmatch_perceptual_wasm.d.ts" */
 ...
 * @returns {number}
 */
export function audio_ber_json(a_json, b_json) {
    ...
    const ret = wasm.audio_ber_json(ptr0, len0, ptr1, len1);
    if (ret[2]) {
 ...
 * @returns {string}
 */
export function fingerprint_audio_json(samples_json, sample_rate) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(samples_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.fingerprint_audio_json(ptr0, len0, sample_rate);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
 ...
 * @returns {number}
 */
export function hamming_hex(a_hex, b_hex) {
 ...
 * @returns {string}
 */
export function radial_variance_json(grid_json) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(grid_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.radial_variance_json(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./goldenmatch_perceptual_wasm_bg.js": import0,
    };
}

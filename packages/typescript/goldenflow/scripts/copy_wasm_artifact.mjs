...
// loader might resolve `new URL('./artifacts/goldenflow_wasm_bg.wasm', import.meta.url)`
...
// enableWasm() resolve the artifact in the published package regardless
...
const files = ["goldenflow_wasm_bg.wasm", "goldenflow_wasm.js"];
const dsts = [

...
import {
  ...
  urlStripWwwTs,
  urlCanonicalTs,
} from "../../src/core/transforms/url.js";
import {
  currencyStripTs,
...
const PURE_TS_FN: Record<string, (s: string) => boolean | string | number | undefined> = {
  ...
  isin_validate: isinValidateTs,
  cusip_validate: cusipValidateTs,
  npi_validate: npiValidateTs,
  luhn_validate: luhnValidateTs,
  cc_brand: ccBrandTs,
  name_initials: nameInitialsTs,
  strip_middle: stripMiddleTs,
  roman_to_int: romanToIntTs,
  ordinal_to_int: ordinalToIntTs,
  fraction_to_decimal: fractionToDecimalTs,
  ...
  email_canonical: emailCanonicalTs,
  email_mask: emailMaskTs,
  ...
  url_strip_tracking: urlStripTrackingTs,
  url_strip_www: urlStripWwwTs,
  url_canonical: urlCanonicalTs,
...
function wasmFn(backend: FlowWasmBackend, transform: string): (s: string) => boolean | string | number | undefined {
  const map: Record<string, (s: string) => boolean | string | number | undefined> = {
    ...
    isin_validate: (s) => backend.isinValidate(s),
    cusip_validate: (s) => backend.cusipValidate(s),
    npi_validate: (s) => backend.npiValidate(s),
    luhn_validate: (s) => backend.luhnValidate(s),
    cc_brand: (s) => backend.ccBrand(s),
    name_initials: (s) => backend.nameInitials(s),
    strip_middle: (s) => backend.stripMiddle(s),
    roman_to_int: (s) => backend.romanToInt(s),
    ordinal_to_int: (s) => backend.ordinalToInt(s),
    fraction_to_decimal: (s) => backend.fractionToDecimal(s),
    ...
    email_canonical: (s) => backend.emailCanonical(s),
    ...
    url_strip_tracking: (s) => backend.urlStripTracking(s),
    url_strip_www: (s) => backend.urlStripWww(s),
    url_canonical: (s) => backend.urlCanonical(s),

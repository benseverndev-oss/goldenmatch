...
| Topic | Link |
|---|---|
| YAML reference | [Configuration](/goldenmatch/configuration) |
| `goldenmatch memory ...` | [CLI Reference](/goldenmatch/cli) |
| `goldenmatch.add_correction` etc. | [Python API](/goldenmatch/python-api) |
| MCP `list_corrections` etc. | [MCP Server](/goldenmatch/mcp) |
| Review queue (the steward UI) | [REST API](/goldenmatch/rest-api) |

...
- [Scoring](/goldenmatch/scoring) — full scorer reference
- [Configuration](/goldenmatch/configuration) — matchkey + transform schema
- [Pipeline](/goldenmatch/pipeline) — where the refinement hook fires

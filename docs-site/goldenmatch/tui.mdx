...
description: "Gold-themed terminal UI for GoldenMatch: 7 tabs for data profiling, configuration, match review, golden records, active learning, export, and AutoConfigController telemetry."

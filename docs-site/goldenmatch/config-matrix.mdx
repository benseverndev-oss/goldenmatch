...
| `link_cut_rule` | Literal \| None | `None` | `midpoint`, `prior`, `prior_mid`, `posterior_099`, `evidence_3`, `evidence_5`, `evidence_9`, `evidence_12`, `otsu` -- Rule that places the probabilistic link cutoff by evidence bits, for example prior_mid or evidence_9. Unset uses the default rule; link_threshold, when set, still wins. |

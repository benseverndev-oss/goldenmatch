...
Calibration activates automatically when candidates exceed `calibration_sample_size`. For small candidate sets (&le;100 pairs), all pairs are scored directly.

---
title: "Pipeline"
description: "GoldenMatch's 10-step pipeline from raw files to golden records, with per-step API references."
keywords: ["pipeline", "ingest", "blocking", "scoring", "clustering", "golden records", "matchkeys"]
---

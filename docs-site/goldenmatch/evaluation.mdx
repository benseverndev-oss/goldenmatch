---
title: "Evaluation"
description: "Measure matching accuracy against ground truth and enforce quality gates in CI/CD pipelines."
keywords: ["evaluation", "ground truth", "f1", "precision", "recall", "ci/cd", "quality gate"]
---

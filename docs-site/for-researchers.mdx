...
for the dataset source, drop location, and expected output per number.
...
|---|---|---|---|
| historical_50k | **0.827** | 0.757 | +0.070 (cluster B³: 0.862 vs 0.788) |
...
- **Bibliographic data:** the probabilistic path is weak on `dblp_acm` (F1 0.381,
...
pan out, and are useful as prior art:

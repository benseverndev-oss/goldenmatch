...
**Latest: 2026-09-11** (vs previous snapshot)
...
| npm downloads (30d, suite) | 3.1k | 3.1k (▬0) | actual reach (TS) |
| Open issues, non-maintainer | 1 | 1 (▬0) | "someone reached for it"† |
| Time-to-first-success | 17.9s · F1 1.00 | ▼-1.4s | zero-config friction‡ |

...
**Latest: 2026-09-12** (vs previous snapshot)
...
| npm downloads (30d, suite) | 3.0k | 3.0k (▼-89) | actual reach (TS) |
| Open issues, non-maintainer | 1 | 1 (▬0) | "someone reached for it"† |
| Time-to-first-success | 20.2s · F1 1.00 | ▲+2.3s | zero-config friction‡ |

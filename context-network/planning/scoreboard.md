...
**Latest: 2026-09-17** (vs previous snapshot)

| Signal | Now | WoW | North Star reading |
|---|---|---|---|
| GitHub stars | 132 | 132 (▲+1) | discovery momentum |
| Forks | 14 | 14 (▬0) | intent-to-use |
| PyPI downloads (30d, suite) | — | — | actual reach |
| npm downloads (30d, suite) | 1.6k | 1.6k (▼-1373) | actual reach (TS) |
| Open issues, non-maintainer | 1 | 1 (▬0) | "someone reached for it"† |
| Time-to-first-success | 20.3s · F1 1.00 | ▼-4.0s | zero-config friction‡ |

...
**Latest: 2026-09-20** (vs previous snapshot)
...
| npm downloads (30d, suite) | 1.5k | 1.5k (▼-1) | actual reach (TS) |
| Open issues, non-maintainer | 1 | 1 (▬0) | "someone reached for it"† |
| Time-to-first-success | 23.4s · F1 1.00 | ▲+7.3s | zero-config friction‡ |

...
**Latest: 2026-09-10** (vs previous snapshot)
...
| npm downloads (30d, suite) | 3.1k | 3.1k (▼-152) | actual reach (TS) |
| Open issues, non-maintainer | 1 | 1 (▬0) | "someone reached for it"† |
| Time-to-first-success | 19.3s · F1 1.00 | ▲+0.2s | zero-config friction‡ |
